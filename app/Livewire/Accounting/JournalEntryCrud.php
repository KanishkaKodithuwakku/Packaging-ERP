...
class JournalEntryCrud extends Component
{
    use WithPagination;
    ...
    public function openAddEntryModal()
    {
        $this->resetForm();
        $this->showModal = true;
        $this->dispatch('modal-opened');
        session()->flash('message', 'Journal entry modal opened!');
    }
    ...
    public function addEntry()
    {
        ...
        $entry = Entry::create([
            'date' => $this->form['date'],
            'entry_type_id' => $this->form['entry_type_id'],
    ...
    public function render()
    {
        ...
        return view('livewire.accounting.journal-entry-crud', [
            'entries' => $entries,
