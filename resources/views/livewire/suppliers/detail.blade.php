        ...
        <div class="p-6">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-3 text-sm">{{ number_format($size->reel_size, 2) }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="2" class="px-6 py-6 text-center text-gray-500">No reel sizes</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <div class="mt-3">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.01" wire:model.defer="reelForm.reel_size" class="mt-1 block w-full border-gray-300 rounded-md" />
                    </div>
                </div>
