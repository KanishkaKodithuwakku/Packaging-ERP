        ...
        <h4 class="text-lg font-medium text-gray-900 mb-4">Add New Divider</h4>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
            <div>
                ...
                @error('dividerForm.ply') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" 
                       ...
                       class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                       placeholder="1000">
                @error('dividerForm.quantity') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                @error('dividerForm.unit') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                @error('dividerForm.fsc_claim') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
            </div>
        </div>
        
        <!-- Combination Parameters -->
        <div class="mb-6">
            <h5 class="text-md font-medium text-gray-700 mb-2">Combination</h5>
            <!-- Single Row - 5 inputs -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-7 gap-4">
                <div>
                    ...
                    <input type="number" 
                           ...
                           class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-white"
                           placeholder="0.00">
                </div>
            </div>
        </div>
