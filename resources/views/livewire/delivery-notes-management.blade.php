                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($deliveryNotes as $dn)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $dn->jobOrder->job_number }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $dn->jobOrder->customer->name ?? 'N/A' }}</td>
