    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <!-- Header -->
                <div class="mb-6">
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">Ledger Entries</h1>
                    <p class="text-gray-600">List of all entries for a specific ledger account (newest first)</p>
                </div>

                <!-- Ledger Selection Form -->
                <div class="mb-6 bg-gray-50 p-4 rounded-lg">
                    <form wire:submit.prevent="generateLedgerEntries">
                ...
                @if($showEntries && $ledger)
                    ...
                    <div class="mt-8 p-4 bg-blue-50 rounded-lg">
                        <div class="text-center">
                            <h3 class="text-lg font-semibold text-blue-900 mb-2">Ledger Entries Summary</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <span class="ml-2">{{ $startDate ? \Carbon\Carbon::parse($startDate)->format('d-M-Y') : 'Start of Year' }} to {{ $endDate ? \Carbon\Carbon::parse($endDate)->format('d-M-Y') : 'End of Year' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
